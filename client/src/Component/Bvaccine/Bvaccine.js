      ...
      <div className="body">
        <div className="header">
          <div className="container ">
            ...
            <p className="slogan">
              I​mmunisation is an important way to protect your child from
              certain life-threatening diseases. All the diseases that your
              child is protected against are serious diseases and by immunising
              your child, you are also ensuring better protection for the
              population.{" "}
            </p>
            ...
            <div className="takeinfo">
              ...
              <form className="form" action="">
                ...
                <input
                  ...
                  id="babyName"
                  class="form-control"
                  placeholder="Enter Your Baby Name Here"
                ></input>
                ...
                <input
                  ...
                  id="gender"
                  class="form-control"
                  placeholder="Enter Your Baby Gender"
                ></input>
        ...
        <div id="vaccineTable" className="container p-3 hide">
          <h3 className="lasttitle" style={{ color: "black" }}>
            {" "}
